<template>
    <TenantLayout>
        <div class="mb-8 flex items-end justify-between">
            ...
            <a v-if="record.document_no" :href="`/service-records/${record.id}/download-document`" target="_blank" class="flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-emerald-500/20 transition hover:bg-emerald-500">
