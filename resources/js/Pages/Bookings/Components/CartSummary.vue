<!-- resources/js/Pages/Bookings/Components/CartSummary.vue -->
<template>
    <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
        <div class="border-b border-gray-100 bg-gray-50/50 px-6 py-4">
            <div class="font-bold text-gray-900">Booking Control Summary</div>
        ...
        <div class="space-y-5 p-6">
            ...
            <div class="rounded-xl border border-dashed border-gray-200 bg-gray-50 p-4 text-xs text-gray-600">
                The booking payload will be created only when routing is complete and at least one service line exists.
            </div>
            ...
            >
                ...
                {{ processing ? 'Submitting...' : 'Create Master Booking' }}
            </button>
        </div>
    </div>
</template>
